                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control <?= form_error('email') ? 'is-invalid' : ''; ?>" id="email" name="email" value="<?= $user['email']; ?>" readonly>
                                <div class="invalid-feedback">
                                    <?= form_error('email') ?>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            <label for="password1" class="col-sm-2 col-form-label">Reset Password</label>
                            <div class="col-sm-10">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select <?= form_error('role') ? 'is-invalid' : ''; ?>" id="role" name="role" aria-label="Default select example">
                                    <?php foreach ($roles as $key => $data) : ?>
                                        <option value="<?= $data->id_role; ?>" <?= $user['id_role'] == $data->id_role ? 'selected' : ''; ?>><?= ucwords($data->role); ?></option>
                                    <?php endforeach ?>
                                </select>
                                <div class="invalid-feedback">
                                    <?= form_error('role') ?>
